...
namespace Mock3
{
    ...
    {
        [Header("参照")] [SerializeField] private GameManager2 _gameManager;
        [SerializeField] private PlayerController _playerController;

        [Header("UI要素")] [SerializeField] private RectTransform _scorePanel;
        ...
        [Header("ターン表示")] [SerializeField] private float _turnIndicatorDuration = 1.5f;
        ...
        // トランジション設定
        [Header("トランジション")] [SerializeField] private float _transitionDuration = 0.5f;
        ...
        private void Start()
        {
            ...
            // コンボ変更の購読
            _comboSubscription = _gameManager.ComboCount.Subscribe(combo => { PulseComboPanel(combo); });
