...
namespace Mock3
{
    ...
    public class BulletController : MonoBehaviour
    {
        ...
        [Header("移動設定")] [SerializeField] private float _speed = 50f;
        ...
        [Header("視覚エフェクト")] [SerializeField] private TrailRenderer _trailRenderer;
        ...
        private async UniTask StartBulletSequence()
        {
            ...
            if (_bulletMaterial != null && _bulletMaterial.HasProperty("_EmissionColor"))
            {
                DOTween.To(() => 0.1f, x => _bulletMaterial.SetColor("_EmissionColor", _originalEmissionColor * x), 2f,
                        0.5f)
        ...
        private void Update()
        {
            ...
            {
                transform.position =
                    new Vector3(_enemy.transform.position.x, transform.position.y, transform.position.z);
            }
