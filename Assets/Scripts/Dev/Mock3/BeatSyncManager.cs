...
namespace Mock3
{
    ...
    {
        [Header("BPM設定")] [SerializeField] private float _bpm = 200f;
        [SerializeField] private int _beatsPerBar = 4; // 1小節あたりの拍数

        [Header("視覚的フィードバック")] [SerializeField]
        private RectTransform _beatIndicator; // 拍のビジュアルインジケーター

        [SerializeField] private Color _downbeatColor = Color.red; // 小節の頭の拍の色
        [SerializeField] private Color _beatColor = Color.white; // 通常の拍の色

        [Header("デバッグ")] [SerializeField] private bool _showDebugInfo = true;
